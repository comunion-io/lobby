            ...
            <div class="section-card">
              ...
              <div class="card-content">
                ...
                <div class="org-name-check">
                  ...
                  <svg
                    v-show="newOrg.name && !isOrgNameInCheck && isOrgNameValid"
                    class="icon"
                    aria-hidden="true"
                  >
                ...
                <div
                  v-if="!newOrg.name || !newOrg.name.replace(/(^\s*)|(\s*$)/g, '')"
                  class="tip"
                >Please input your organization name</div>
                <div v-else>
                  <div
                    v-show="!isOrgNameInCheck && isOrgNameValid"
                    class="tip"
                  >The organization name is available.</div>
                  <div
                    v-show="!isOrgNameInCheck && !isOrgNameValid"
                    class="tip error"
                  >Organization name already exists</div>
                </div>
                <el-button
                  :class="['btn-main', 'btn-wide', isOrgNameValid ? '' : 'disable']"
                  round
                  @click="isOrgNameValid?curStep='step2':''"
                >Next</el-button>
              </div>
            </div>
          </div>
            ...
            <div class="inner-content">
              <div class="section-card">
                ...
                <div class="card-content">
                  ...
                  <el-button
                    :class="['btn-main', 'btn-wide', isInfo1Valid ? '' : 'disable']"
                    round
                    @click="checkInfo1"
                  >Next</el-button>
                </div>
              ...
              <div class="section-card">
                ...
                <div class="card-content">
                  ...
                  <el-form-item label="Social Media">
                    <el-input
                      v-for="(social,index) in newOrg.social"
                      :key="index"
                  ...
                  <el-button
                    :class="['btn-main', 'btn-wide', isInfo2Valid ? '' : 'disable']"
                    round
                    @click="checkInfo2Click"
                  >Next</el-button>
                </div>
              </div>
            </div>
            ...
            <div class="inner-content">
              <div class="section-card">
                ...
                <div class="card-content">
                  ...
                  <div class="tip">
                    <strong>-The initial password will be sent to this E-mail, and this E-mail is used to login to your account.</strong>
                    <br />-You can complete your profile later after creating the organization.
                  </div>
                  <el-button class="btn-main" round @click="curInfo = 'info2'">Previous</el-button>
                  <el-button
                    :class="['btn-main', 'btn-wide', isEmailValid ? '' : 'disable']"
                    round
                    @click="checkEmailClick"
                  >Next</el-button>
                </div>
              </div>
            </div>
          ...
          <div class="inner-content">
            <div class="section-card">
              ...
              <div class="tip nomargin left">
                This is the last step : ) &nbsp; You will need to sign the transaction to register your organization.
...
export default {
    ...
    return {
      ...
      orgRules: {
        ...
        mission: [
          {
            required: true,
            message: 'please input organization mission',
            trigger: 'blur'
          }
        ],
        vision: [
          {
            required: true,
            message: 'please input organization vision',
            trigger: 'blur'
          }
        ],
        description: [
  ...
  created() {
    this.checkIfInstallMataMaskOld()
