    ...
    <el-form ref="orgForm" :model="orgForm">
      ...
      <div class="section-card">
        <div class="card-title">
          ...
          <div class="card-tool">
            <svg
              v-if="!isAboutInEdit && isOwner"
              class="icon"
              aria-hidden="true"
              @click="handleClickEdit('isAboutInEdit')"
            >
        ...
        <div class="card-content">
          <el-form-item label="Mission">
            <div v-if="!isAboutInEdit && isOwner" class="el-input fake">{{ orgForm.mission }}</div>
            <el-input v-if="isAboutInEdit && isOwner" v-model="orgForm.mission" />
          </el-form-item>
          <el-form-item label="Vision">
            <div v-if="!isAboutInEdit && isOwner" class="el-input fake">{{ orgForm.vision }}</div>
            <el-input v-if="isAboutInEdit && isOwner" v-model="orgForm.vision" />
          </el-form-item>
          <el-form-item label="Desccription">
            <div
              v-if="!isAboutInEdit && isOwner"
              class="el-input fake textarea"
            >{{ orgForm.description }}</div>
            <el-input
              v-if="isAboutInEdit && isOwner"
      ...
      <div class="section-card">
        <div class="card-title">
          ...
          <div class="card-tool">
            <svg
              ...
              class="icon"
              aria-hidden="true"
              @click="handleClickEdit('isContactInEdit')"
            >
              <use xlink:href="#icon-edit" />
            </svg>
            <svg
        ...
        <div class="card-content">
          ...
          <el-form-item label="Social Media">
            ...
            <div v-else>
              <el-input
                v-for="(social,index) in orgForm.social"
                :key="social.name"
